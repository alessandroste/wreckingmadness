namespace WreckingMadness.Functions.Common
{
    using System.IO;
    ...
    /// </summary>
    public class SystemSerializer : CosmosSerializer
    {
        private readonly JsonObjectSerializer systemTextJsonSerializer;

        public SystemSerializer(JsonSerializerOptions jsonSerializerOptions = null)
        {
